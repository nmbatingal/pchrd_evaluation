...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"`sessions`.`remarks`" => "remarks",
		"`sessions`.`has_token`" => "has_token"
	);
	...
	$x->QueryFieldsFilters = array(   
		"`sessions`.`id`" => "ID",
		"`sessions`.`session_name`" => "Session name",
		"`sessions`.`remarks`" => "Remarks",
		"`sessions`.`has_token`" => "Has token"
	);
	...
	$x->TableTitle = "Sessions";
	$x->TableIcon = "table.gif";
	$x->PrimaryKey = "`sessions`.`id`";

	$x->ColWidth   = array(  150, 150, 150);
	$x->ColCaption = array("Session name", "Remarks", "Has token");
	$x->ColFieldName = array('session_name', 'remarks', 'has_token');
