	...
	$lookups = array(   
		...
		'speakers' => array(   
			'session_id' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`sessions`.`session_name`',
		...
		'session_questions' => array(   
			...
			'question_id' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`questions`.`question`',
				'parent_from' => '`questions` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'question_type' => array(
				'parent_table' => 'question_types',
				'parent_pk_field' => 'id',
				'parent_caption' => '`question_types`.`type`',
				'parent_from' => '`question_types` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'responses' => array(   
			'respondent_id' => array(
				'parent_table' => 'respondents',
				'parent_pk_field' => 'id',
				'parent_caption' => '`respondents`.`name`',
				'parent_from' => '`respondents` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'question_id' => array(
				'parent_table' => 'session_questions',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(    CHAR_LENGTH(`questions1`.`question`), CONCAT_WS(\'\',   `questions1`.`question`), \'\')',
				'parent_from' => '`session_questions` LEFT JOIN `sessions` as sessions1 ON `sessions1`.`id`=`session_questions`.`session_id` LEFT JOIN `questions` as questions1 ON `questions1`.`id`=`session_questions`.`question_id` LEFT JOIN `question_types` as question_types1 ON `question_types1`.`id`=`session_questions`.`question_type` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
