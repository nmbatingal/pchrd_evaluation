	...
	*/
	...
	$schema = array(   
		'question_types' => array(   
			...
			'type' => array('appgini' => 'VARCHAR(255) null '),
			'remarks' => array('appgini' => 'TEXT null ')
		),
		'questions' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'question' => array('appgini' => 'VARCHAR(255) null '),
			'remarks' => array('appgini' => 'TEXT null ')
		),
		'sessions' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'session_name' => array('appgini' => 'VARCHAR(255) null '),
			'remarks' => array('appgini' => 'TEXT null '),
			'has_token' => array('appgini' => 'VARCHAR(40) null ')
		),
		'speakers' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'full_name' => array('appgini' => 'VARCHAR(255) null '),
			'session_id' => array('appgini' => 'INT unsigned null ')
		),
		'session_questions' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'session_id' => array('appgini' => 'INT unsigned null '),
			'question_id' => array('appgini' => 'INT unsigned null '),
			'question_type' => array('appgini' => 'INT unsigned null '),
			'order' => array('appgini' => 'INT unsigned null ')
		),
		'responses' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'respondent_id' => array('appgini' => 'INT unsigned null '),
			'question_id' => array('appgini' => 'INT unsigned null '),
			'response' => array('appgini' => 'TEXT not null ')
		),
		'respondents' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'name' => array('appgini' => 'VARCHAR(40) null '),
			'institution' => array('appgini' => 'VARCHAR(40) null ')
		)
	);
